...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__plugins_jquery_radioClass__ = __webpack_require__(5);
// Front-End 개발 환경
(function(global, _, $){
  'use strict';
...
let $heading = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<h1>')
                .radioClass('webpack-heading')
                .text( __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.join(messages, ' ') )
                .appendTo('body');
...
_.fn.radioClass = function(class_name) {
  // let $this = this;
  return __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.each(this, (index, item) => {
    // this === 상위 컨텍스트
